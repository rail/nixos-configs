...
let
  home-manager = lib.warn "switch to home-manager 20.03 when it's available" builtins.fetchTarball https://github.com/rycee/home-manager/archive/release-19.09.tar.gz;
